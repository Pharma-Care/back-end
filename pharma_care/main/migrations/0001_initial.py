    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('inventory_manager', 'InventoryManager'), ('pharmacy_technician', 'PharmacyTechnician'), ('pharmacist', 'Pharmacist')], default=None, max_length=20)),
